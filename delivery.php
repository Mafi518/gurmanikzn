...
<body>
          ...
          <div class=" header-right">
            <div class="brand">
              ...
              <div class="mob__social">
                <a href="https://www.instagram.com/gurmani.kzn/"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://vk.com/gurmanikzn"><svg id="Bold" enable-background="new 0 0 24 24" height="512"
  ...
  <div class="delivery">
    ...
    <p>
      <span class="delivery__accent">Самовывоз по адресу</span>
      Казань, ул. Оренбургский тракт, 8В. Самовывоз осуществляется ежедневно до 22:00.
    </p>
    <h2 class="delivery__title">
      Условия доставки
    </h2>
    <p>
      Узнайте условия доставки по вашему адресу в корзине. Начните вводить нужную улицу в разделе «Адрес» и <span
        class="delivery__accent">нажмите</span> на свою улицу в выпадающем списке.
    </p>
    <h2 class="delivery__title">
      Способы оплаты
    </h2>
    ...
    <p>Подробные условия уточняйте у операторов</p>

    <h2 class="delivery__title">
      Время доставки
    </h2>
    <p>
      Среднее время доставки 80 минут. Время доставки может быть увеличено в зависимости от погодных условий и ситуации
      на дороге и иных обстоятельств.
    </p>
  </div>
